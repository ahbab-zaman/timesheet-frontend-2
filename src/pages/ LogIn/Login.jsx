    ...
    try {
      ...
      try {
        ...
        if (employeeData) {
          ...
          toast({
            title: "Access Error",
            description: "Your timesheet portal is currently unavailable. Please contact admin.",
            variant: "destructive",
          });
        }
      } catch {
      ...
      <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-secondary/10 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-foreground">AIREPRO TIMESHEET</h1>
            <p className="text-muted-foreground mt-2">Fill your timesheet to make every hour count ✨</p>
          </div>
